...
<head>
    ...
    <title>BUC Library</title>
    <link rel="stylesheet" href="style.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.2/css/all.min.css" integrity="sha512-HK5fgLBL+xu6dm/Ii3z4xhlSUyZgTT9tuc/hSrtw6uzJOvgRr2a9jyxxT1ely+B+xFAmJKVSTbpM/CuL7qxO8w==" crossorigin="anonymous" />
    <link href="https://fonts.googleapis.com/css2?family=Poppins&display=swap" rel="stylesheet">
</head>
<body>
    <div class="banner" style=" background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('../images/library.png');
    ...
    <div class="form">
        <div class="form-container">
            ...
            <form action="" id="loginform" method="post">
                ...
                <span class='show-hide-adminpass'>
                    <i style="margin-top:10px;" class="fas fa-eye" id="eye-adminpass"></i>
                </span>
